...
import { PieceType } from "../checkers/CheckerCell.js";
import {MyCylinder} from "../primitives/MyCylinder.js";
import {movePiece} from "../checkers/CheckerState.js";
...
export class MyGameView {
    ...
    checkPick() {
        ...
        if (!(this.scene.pickResults != null && this.scene.pickResults.length > 0)) return;
